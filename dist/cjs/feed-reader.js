// feed-reader@6.1.2, by @ndaidong - built with esbuild at 2022-10-02T19:47:35.765Z - published under MIT license
...
var profetch = async (url, proxy = {}, fetchFn = import_cross_fetch.default) => {
...
var retrieve_default = async (url, options = {}) => {
  const {
    ...
    proxy = null,
    fetchFn = import_cross_fetch.default
  } = options;
  const res = proxy ? await profetch(url, proxy, fetchFn) : await fetchFn(url, { headers });
